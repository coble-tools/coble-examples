...
Code link: https://github.com/10XGenomics/single-cell-3prime-paper

Target Figures: Figure 3j,   SuppFigure 5c
*3j: UMAP for S/G2M epithelial cells coloured by MCs.*
![alt text](figures/3j.png)

*Sup 5c: Normalized dispersion vs. mean UMI counts. Black dots represent top most variable genes used for PCA.*   
![alt text](figures/s5c.png)