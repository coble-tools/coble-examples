...
coble build --recipe Fig2_PanelA/cbl/recipe.cbl --env zhang-rec --rebuild
echo "Building conda for Panel(b): Reproduce - Scherer et al (2025) ..."
coble build --recipe Fig2_PanelB/cbl/recipe.cbl --env scherer-rep --rebuild
echo "Building conda for Panel(c): Replicate - Zheng et al (2017) ..."
coble build --recipe Fig2_PanelC/cbl/recipe.cbl --env zheng-rep --rebuild
echo "Building conda for Panel(d): Generalise - Zheng et al (2017) ..."
coble build --recipe Fig2_PanelD/cbl/recipe.cbl --env zheng-gen --rebuild
